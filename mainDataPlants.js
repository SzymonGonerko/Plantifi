...
export const livingroomPlants = [
  ...
  export const searchPlants = [
    ...
    [require("./assets/images/RóżaPospolita.jpg"), {name: "Róża Pospolita", description: "Cięte", profile: profileData.różaPospolita}],
  ...
  export const easyCareCollectionPlants = [
    ...
    [require("./assets/images/easyCarePlants/Grubosz.jpg"), {name: "Grubosz", liked: 600, profile: profileData.grubosz}],
    [require("./assets/images/easyCarePlants/Kaktus.jpg"), {name: "Kaktus", liked: 456, profile: profileData.kaktus}],
    [require("./assets/images/easyCarePlants/KaktusKwitnący.jpg"), {name: "Kaktus Kwitnący", liked: 679, profile: profileData.kaktusKwitnący}],
    ...
    [require("./assets/images/RóżaPospolita.jpg"), {name: "Róża Pospolita", liked: 895, profile: profileData.różaPospolita}],
