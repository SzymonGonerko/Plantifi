const profileData = {
    ...
    dieffenbachiaAmoena: {
      general: {
          ...
          size: "do 120 cm",
          care: "łatwy",
          description: "Difenbachia to jedna z najbardziej popularnych roślin, która zdobi nasze domy, mieszkania, biura czy obiekty użyteczności publicznej. Jest na tyle popularna, że coraz trudniej znaleźć miejsca, w których nie występuje. Chociaż roślina pochodzi z Brazylii, śmiało można powiedzieć, że jest w Polsce traktowana jak narodowe dobro. Co powinniśmy wiedzieć o Difenbachii? Jak ją uprawiać i pielęgnować? Czy łatwo można ją rozmnażać i poszerzać posiadane zbiory tej efektywnej rośliny? Przyjrzyjmy się tematowi z bliska. Ciekawi? Zaczynamy!"
        },
        requirements: {
          insolation: {inWords: "wysokie", inPercentage: 87},
          temperature: {inWords: "19°C", inPercentage: 40},
          position: {inWords: "przy", inPercentage: 80},
          whiff: {inWords: "lekki", inPercentage: 7},
          humidity: {inWords: "Wysoka", inPercentage: 95},
        },
        care: {
          watering: {
  ...
  aloeVera: {
    general: {
        ...
        size: "do 60 cm",
        care: "łatwy",
        description: "Powszechnie przyjmuje się, że aloes pochodzi z południowych obszarów Półwyspu Arabskiego, a stamtąd zawędrował on między innymi do Maroka, Mauretanii, Egiptu i w głąb Afryki. Znali go także starożytni Indusi i Chińczycy, a także dotarł on do krajów śródziemnomorskich, Ameryki Łacińskiej i Australii. Aloes zwyczajny jest wieloletnim sukulentem należącym do rodziny liliowatych i jest jedną z najłatwiejszych w uprawie roślin. Chętnie wybierany jest więc przez osoby chcące posiadać je w domu, ale niemające ręki do wielu innych gatunków. Do tego dość szybko rośnie i da się go łatwo rozmnażać. "
      },
      requirements: {
        insolation: {inWords: "wysokie", inPercentage: 96},
        temperature: {inWords: "20°C", inPercentage: 50},
        position: {inWords: "przy", inPercentage: 87},
        whiff: {inWords: "średni", inPercentage: 48},
        humidity: {inWords: "niska", inPercentage: 3},
      },
      care: {
        watering: {
...
bambusLuckyBamboo: {
  general: {
      ...
      size: "do 1.5 m",
      care: "łatwy",
      description: "Lucky Bamboo, pomimo swojej nazwy – Szczęśliwy Bambus oraz łudzącego podobieństwa, tak naprawdę nie jest bambusem – jest to Dracena Sandera (Dracena sanderiana), populara roślina doniczkowa, jedna z wielu domowych dracen. Roślina pochodzi z południowej Azji i to właśnie tam jest najbardziej popularna. W ostatnich latach, dzięki masowej produkcji Lucky Bamboo stał się popularny na całym świecie. Dziś można go kupić w każdej kwiaciarni lub supermarkecie."
    },
    requirements: {
      insolation: {inWords: "średnie", inPercentage: 43},
      temperature: {inWords: "22°C", inPercentage: 60},
      position: {inWords: "obok", inPercentage: 14},
      whiff: {inWords: "niski", inPercentage: 20},
      humidity: {inWords: "wysoka", inPercentage: 72},
    },
    care: {
      watering: {
...
grubosz: {
  general: {
      ...
      size: "do 1 m",
      care: "łatwy",
      description: "Grubosz (Crassula) to nazwa licznego rodzaju roślin należących do rodziny gruboszowatych (Crassulaceae). Drzewkiem szczęścia nazwa się głównie grubosza jajowatego (Crassula ovata), który jest znany pod nazwami: grubosz owalny, grubosz srebrzysty lub drzewko pieniędzy. W naszej strefie klimatycznej jest rośliną doniczkową, ale w warunkach swojego naturalnego występowania (Afryka) osiąga do 4 m wysokości! Grubosze uprawiane w doniczkach mogą dorastać do ok. 1 m wysokości. Ich kora jest dość jasna, błyszcząca, o ciekawej fakturze z charakterystycznymi pierścieniami. Liście są jajowatego kształtu, żywo zielone i błyszczące. "
    },
    requirements: {
      insolation: {inWords: "niskie", inPercentage: 31},
      temperature: {inWords: "21°C", inPercentage: 58},
      position: {inWords: "dalej", inPercentage: 10},
      whiff: {inWords: "łagodny", inPercentage: 13},
      humidity: {inWords: "niska", inPercentage: 16},
    },
    care: {
      watering: {
